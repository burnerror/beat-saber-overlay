...
const check_id = ["overlay","rank","percentage","combo","score","progress","energy_area",
                  ...
                  "now_pp","now_pp_text","star","star_text","starBL","star_textBL","pp","pp_text","label_header",
...
if (html_id["star_textBL"])   var star_textBL_org   = document.getElementById("star_textBL").textContent;
